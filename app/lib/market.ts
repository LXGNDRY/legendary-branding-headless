...
/**
 * Shopify's LanguageCode values are ISO language codes, optionally followed
 * by a region (for example PT_BR). The final availability check happens
 * against Shopify's localization response before a value is saved.
 */
